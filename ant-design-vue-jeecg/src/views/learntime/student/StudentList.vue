...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getSuperFieldList(){
        let fieldList=[];
        fieldList.push({type:'string',value:'username',text:'登录账号(学生学号)',dictCode:''})
        fieldList.push({type:'string',value:'password',text:'登录密码',dictCode:''})
        fieldList.push({type:'string',value:'realname',text:'学生姓名',dictCode:''})
        fieldList.push({type:'string',value:'college',text:'学院',dictCode:'college,name,id'})
        fieldList.push({type:'string',value:'major',text:'专业',dictCode:'major,name,id'})
        fieldList.push({type:'string',value:'grade',text:'年级',dictCode:'grade,name,name'})
        fieldList.push({type:'int',value:'clbum',text:'班级',dictCode:''})
